...
class _MyTextFieldState extends State<MyTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    /// 临时修复方法：https://github.com/flutter/flutter/issues/68571 (issues/61446)
    ...
    if (widget.getVCode != null) {
      getVCodeButton = MyButton(
        ...
        disabledTextColor: isDark ? ColorConst.dark_text : Colors.white,
        backgroundColor: Colors.transparent,
        disabledBackgroundColor: isDark ? ColorConst.dark_text_gray : ColorConst.text_gray_c,
        radius: 1.0,
        minHeight: 26.0,
        minWidth: 76.0,
