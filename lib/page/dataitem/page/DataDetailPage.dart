...
import 'package:hello_flutter/page/dataitem/page/DataChartPage.dart';
import 'package:hello_flutter/page/dataitem/page/DataSinglePage.dart';
...
class _DataDetailPageState extends State<DataDetailPage> with TickerProviderStateMixin {
  ...
  ValueNotifier<String> _selectTitle = ValueNotifier<String>('选择家庭成员');
