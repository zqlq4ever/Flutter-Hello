...
class _SettingPageState extends State<SettingPage> {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              ...
              child: _settingItem(index, context),
            );
          },
  ...
  void _itemClick(int index) {
    switch (index) {
      //  头像
      case 0:
        HeaderMenuDialog(context, (isCamera) {
          _getImage(isCamera);
        }, (headerString) {
          setState(() {
  ...
  _settingItem(int index, BuildContext context) => Container(
        height: 50,
        color: Colors.white,
        child: Row(
          children: [
