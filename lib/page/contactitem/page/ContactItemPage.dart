...
import 'package:hello_flutter/page/contactitem/widget/call_menu_dialog.dart';
...
class ContactItemPage extends StatefulWidget {
  const ContactItemPage({Key? key}) : super(key: key);

  @override
  _ContactItemPageState createState() => _ContactItemPageState();
}

class _ContactItemPageState extends State<ContactItemPage> {
  @override
        ...
        itemBuilder: (context, index) => Stack(
          children: [
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: () => CallMenuDialog(context, (index) {
                    switch (index) {
                      //  视频
                      case 1:
                        break;
